...
const WITHDRAW_REFUND_DELAY = 2 * 60

const SWAP_CONTRACT_TIMELIMIT = 1 * 60
...
async function submitRefundTxIfNotExists({refundTx}) {
    try {
        const refundTxId = refundTx.hash().toString('hex')
    ...
    return await stellar.submitTransaction(refundTx)
}
