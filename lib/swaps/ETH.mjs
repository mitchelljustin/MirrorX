...
const WITHDRAW_REFUND_DELAY = 5 * 60
...
async function genWithdrawTransactions({
        hashlock,
        swapSize,
        holdingAccount,
        depositorAccount,
    ...
    const ethAddrBuf = Buffer.from(withdrawerEthAddr, 'hex')
...
export default {Deposit, Withdraw, swapSizes}