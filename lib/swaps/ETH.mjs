...
const WITHDRAW_REFUND_DELAY = 40 * 60

const SWAP_CONTRACT_TIMELIMIT = 20 * 60
...
export async function processHoldingTx({
    ...
    let fundHolding, addFulfiller, addHashlock,
        addRefundTx, addRefundTxWithdrawer, adjustSignerWeights
...
export async function submitStellarTxIfNotExists(tx) {
    try {
...
export async function genStellarDrainHoldingTx({holdingAccount, withdrawerAccount, refundTx}) {
