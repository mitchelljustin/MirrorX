...
const UPDATE_OFFER_PRICE_RETRY_INTERVAL = 60 * 1000
...
export default class Anchor {
    ...
    async getActiveOffers() {
        ...
        for (const offer of offers.records) {
            ...
            if (selling.asset_code === this.asset.getCode() &&
                ...
                if (sellOffer) {
                    console.warn(`WARNING: found multiple sell offers`)
                }
                sellOffer = offer
            }
            if (buying.asset_code === this.asset.getCode() &&
                ...
                if (buyOffer) {
                    console.warn(`WARNING: found multiple buy offers`)
                }
                buyOffer = offer
            }
        }
    ...
    async updateOfferPrice() {
        ...
        try {
            ...
            setTimeout(this.updateOfferPrice.bind(this), UPDATE_OFFER_PRICE_RETRY_INTERVAL)
        }
    }
}